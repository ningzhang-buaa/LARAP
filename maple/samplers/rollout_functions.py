...
def rollout(
    ...
    while path_length < max_path_length:
        ...
        a, agent_info = agent.get_action(epoch, o_for_agent, env_info, **get_action_kwargs)
        #observation :robot0_eef_pos 3,robot0_eef_quat 4,robot0_gripper_qpos 2,robot0_gripper_qvel 2
        #cube_pos 3,cube_quat 4,gripper_to_cube_pos 3  21*1
        #print(o_for_agent)
        #print(o_for_agent[18:21])
        #print(a)
        #print(agent_info)
