...
class Softmax(Distribution):
    def __init__(self, logits, probs, one_hot=False, prefix=''):
        self.logits = logits
        self.check_logits()
    ...
    def sample(self):
        ...
        try:
            if not self.one_hot:
                ...
                #print(self.distr.sample())
                #print(self.distr.probs)
                #print(self.distr.logits)
                #print('dist1')
